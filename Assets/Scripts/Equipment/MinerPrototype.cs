...
#nullable enable
    ...
    public class MinerPrototype : EquipmentPrototype {
        public float Range;
        ...
        public StructureSOToFloatDictionary AsteroidDamageMultipliers = new StructureSOToFloatDictionary ();
            ...
            if (state.Activated) {
                ...
                */
                if (state.AccumulatedDamageMultiplier >= DamageInterval) {
                    state.Target.TakeDamage (DamagePerSecond * state.AccumulatedDamageMultiplier * HeatDamageMultiplier.Evaluate (state.Heat / MaxHeat) * AsteroidDamageMultipliers[state.Target.Profile], slot.Equipper.transform.position);
        ...
        public new class State : EquipmentPrototype.State {
            ...
            public State (EquipmentSlot slot, MinerPrototype equipment) : base (slot, equipment) { }
