...
public class StatSaveData : SerializedBase<IStat> {
    ...
    public StatSaveData (StatInstance serializable) {
        ...
        Modifiers = serializable.Modifiers.FindAll ((e) => e is ISerializable<IStatModifier>).ConvertAll ((e) => JsonUtility.ToJson ((e as ISerializable<IStatModifier>).GetSerialized ()));
        Id = serializable.Id;
