...
namespace Framework.Persistence
{
    public class PersistentDataConverter : JsonConverter<PersistentData>
    {
        ...
        public override PersistentData? ReadJson(JsonReader reader, Type objectType, PersistentData? existingValue, bool hasExistingValue, JsonSerializer serializer)
        {
