...
namespace DarkFrontier.Objects.Selectables
{
    public class Selector : VisualElement
    {
        ...
        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            ...
            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                ...
                ate.UnselectedSprite = Addressables.LoadAssetAsync<Sprite>(_unselectedSpriteAddress.GetValueFromBag(bag, cc)).WaitForCompletion();
                ate.SelectedSprite = Addressables.LoadAssetAsync<Sprite>(_selectedSpriteAddress.GetValueFromBag(bag, cc)).WaitForCompletion();
